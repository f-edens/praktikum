...
set xrange [ -25 : 25 ] noreverse nowriteback
...
GNUTERM = "wxt"
k = 4.83072340082927
plot 'diagramme/einzel0075.txt' u ($1*k-4.62887e-05):2 w dots t '0,075 mm', \
     5.78198 * sin(0.402965181454796 * (x - 4.63577e-05))**2 / x**2 + 0.0409348 t 'fit 0,075 mm', \
     'diagramme/einzel0150.txt' u ($1*k-1.09499e-05):2 w dots t '0,15 mm', \
     1.34642 * sin(0.839573 * (x - 1.12444e-05))**2 / x**2 + 0.0405313 t 'fit 0,15 mm', \
     'diagramme/einzel0400.txt' u ($1*k+0.000649196):2 w dots t '0,4 mm', \
     5.86761   * sin(0.400937  * (x - -0.000642643))**2 / x**2 + 0.0419424 t 'fit 0,4 mm'
#    EOF
