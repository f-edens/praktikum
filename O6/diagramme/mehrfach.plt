...
GNUTERM = "wxt"
k = 4.83072340082927
plot 'diagramme/mehrfach40.txt' u ($1*k):2 w dots t '40 Spalten',\
	 'diagramme/mehrfach05.txt' u ($1*k):2 w dots t '5 Spalten',\
     'diagramme/mehrfach04.txt' u ($1*k):2 w dots t '4 Spalten',\
     'diagramme/mehrfach03.txt' u ($1*k):2 w dots t '3 Spalten'
