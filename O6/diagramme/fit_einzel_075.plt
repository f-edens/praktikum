...
f(x) = a*sin(b*x)**2/x**2 + c
GNUTERM = "wxt"
a = 0.240501778633436
b = 1.96459464830634
GPFUN_f = "f(x) = a*sin(b*x)**2/x**2 + c"
FIT_CONVERGED = 0
FIT_NDF = 402
FIT_STDFIT = 0.018105219150005
FIT_WSSR = 0.131775182108823
c = 0.0517012899042155
plot 'einzel0075.txt', f(x)
## fit f(x) 'einzel0075.txt' every 10 via a,b,c
#    EOF
