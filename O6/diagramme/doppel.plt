...
set xrange [ -25.0000 : 25.0000 ] noreverse nowriteback
set x2range [ -60.8719 : 60.1473 ] noreverse nowriteback
set ylabel "relative Intensität" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 0.00000 : 1.10000 ] noreverse nowriteback
set y2range [ 0.0366879 : 0.999999 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "wxt"
k = 4.83072340082927
plot 'diagramme/doppel025.txt' u ($1*k):2 w dots t 'Spaltabstand 0,25 mm',\
	 'diagramme/doppel050.txt' u ($1*k):2 w dots t 'Spaltabstand 0,50 mm',\
     'diagramme/doppel100.txt' u ($1*k):2 w dots t 'Spaltabstand 1,00 mm'
#    EOF
